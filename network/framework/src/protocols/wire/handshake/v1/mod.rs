...
//!
//! [Libra2Net Handshake v1 Specification]: https://github.com/libra2org/libra2-core/blob/main/specifications/network/handshake-v1.md
...
/// Enum representing different versions of the Libra2 network protocol. These
