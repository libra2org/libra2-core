...
//! This module defines the Libra2Net v1 message types, how they are
...
//!
//! The [Libra2Net Specification](https://github.com/libra2org/libra2-core/blob/main/documentation/specifications/network/messaging-v1.md)
