...
4. Modify `main.tf` file to configure Terraform, and create fullnode from Terraform module. Example content for `main.tf`:
  ...
  module "libra2-node" {
    ...
    source        = "github.com/libra2org/libra2-core.git//terraform/libra2-node/aws?ref=main"
...
For the full customization options, see the variables file [here](https://github.com/libra2org/libra2-core/blob/main/terraform/libra2-node/aws/variables.tf), and the [helm values](https://github.com/libra2org/libra2-core/blob/main/terraform/helm/libra2-node/values.yaml).
