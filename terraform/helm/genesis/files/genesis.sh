...
MOVE_FRAMEWORK_DIR=${MOVE_FRAMEWORK_DIR:-"/libra2-framework/move"}
...
export LIBRA2_DISABLE_TELEMETRY=true
...
# get the framework
# this is the directory the libra2-framework is located in the aptoslabs/tools docker image
