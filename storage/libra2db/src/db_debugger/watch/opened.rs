...
use crate::{db_debugger::ShardingConfig, Libra2DB};
use libra2_config::config::StorageConfig;
...
impl Cmd {
    pub fn run(self) -> Result<()> {
        ...
        .expect("Failed to open Libra2DB");

        println!("Libra2DB opened. Kill to exit.");
