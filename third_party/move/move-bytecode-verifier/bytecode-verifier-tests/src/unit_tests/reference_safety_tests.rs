...
#[test]
fn test_bicliques() {
    // See also: github.com/libra2org/libra2-core/security/advisories/GHSA-xm6p-ffcq-5p2v
...
fn test_merge_state_large_graph() {
    // See also: github.com/libra2org/libra2-core/security/advisories/GHSA-g8v8-fw4c-8h82
    const N: u8 = 127;
...
#[test]
fn test_copyloc_pop() {
    // See also: github.com/libra2org/libra2-core/security/advisories/GHSA-2qvr-c9qp-wch7
