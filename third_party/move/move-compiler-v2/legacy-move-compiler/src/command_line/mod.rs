...
pub const WARN_OF_DEPRECATION_USE_IN_LIBRA2_LIBS: &str = "WARN_OF_DEPRECATION_USE_IN_LIBRA2_LIBS";
pub const WARN_OF_DEPRECATION_USE_IN_LIBRA2_LIBS_FLAG: &str = "Wdeprecation-aptos";
