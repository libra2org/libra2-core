...
module libra2_std::bls12381_algebra {
    //
    ...
    #[test_only]
    use libra2_std::crypto_algebra::{zero, one, from_u64, eq, deserialize, serialize, neg, add, sub, mul, div, inv, rand_insecure, sqr, order, scalar_mul, multi_scalar_mul, double, hash_to, upcast, enable_cryptography_algebra_natives, pairing, multi_pairing, downcast, Element};
    ...
    #[test(fx = @std)]
    #[expected_failure(abort_code = 0x010002, location = libra2_std::crypto_algebra)]
