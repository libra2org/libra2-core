...
use libra2_framework::{extended_checks, path_in_crate, BuildOptions};
...
/// More discussion: https://github.com/libra2org/libra2-core/pull/15997#discussion_r1994469668
...
fn move_framework_unit_tests() {
    run_tests_for_pkg("libra2-framework", false);
}

#[test]
fn move_libra2_stdlib_unit_tests() {
    run_tests_for_pkg("libra2-stdlib", false);
}
...
fn move_token_unit_tests() {
    run_tests_for_pkg("libra2-token", false);
}

#[test]
fn move_token_objects_unit_tests() {
    run_tests_for_pkg("libra2-token-objects", false);
}

#[test]
fn move_experimental_unit_tests() {
    run_tests_for_pkg("libra2-experimental", true);
}
