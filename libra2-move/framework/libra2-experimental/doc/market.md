...
<dt>
<code><a href="pre_cancellation_tracker.md#0x7_pre_cancellation_tracker">pre_cancellation_tracker</a>: <a href="../../libra2-framework/../libra2-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;u8, <a href="pre_cancellation_tracker.md#0x7_pre_cancellation_tracker_PreCancellationTracker">pre_cancellation_tracker::PreCancellationTracker</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>client_order_id: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;u64&gt;</code>
</dt>
<dd>
...
<dt>
<code>details: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/string.md#0x1_string_String">string::String</a></code>
</dt>
<dd>

</dd>
<dt>
<code>metadata_bytes: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;</code>
</dt>
<dd>
...
<dt>
<code>trigger_condition: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="order_book_types.md#0x7_order_book_types_TriggerCondition">order_book_types::TriggerCondition</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>cancel_reason: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="market.md#0x7_market_OrderCancellationReason">market::OrderCancellationReason</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>fill_sizes: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;</code>
</dt>
<dd>
...
): (OrderIdType, u64, Option&lt;<a href="market.md#0x7_market_OrderCancellationReason">OrderCancellationReason</a>&gt;, <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;, u32) {
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_new_market">new_market</a>&lt;M: store + <b>copy</b> + drop&gt;(
    parent: &<a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, <a href="market.md#0x7_market">market</a>: &<a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, config: <a href="market.md#0x7_market_MarketConfig">MarketConfig</a>
    ...
    <b>let</b> <a href="pre_cancellation_tracker.md#0x7_pre_cancellation_tracker">pre_cancellation_tracker</a> = <a href="../../libra2-framework/../libra2-stdlib/doc/table.md#0x1_table_new">table::new</a>();
    ...
    Market::V1 {
        parent: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(parent),
        <a href="market.md#0x7_market">market</a>: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="market.md#0x7_market">market</a>),
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_place_limit_order">place_limit_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    self: &<b>mut</b> <a href="market.md#0x7_market_Market">Market</a>&lt;M&gt;,
    user: &<a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    limit_price: u64,
    orig_size: u64,
    is_bid: bool,
    ...
    self.<a href="market.md#0x7_market_place_order_with_order_id">place_order_with_order_id</a>(
        <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(user),
        limit_price,
        orig_size,
        orig_size,
        is_bid,
        ...
        trigger_condition,
        metadata,
        <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_none">option::none</a>(), // order_id
        client_order_id,
        max_match_limit,
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_place_market_order">place_market_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    self.<a href="market.md#0x7_market_place_order_with_order_id">place_order_with_order_id</a>(
        ...
        <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_none">option::none</a>(), // trigger_condition
        metadata,
        <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_none">option::none</a>(), // order_id
        client_order_id,
        max_match_limit,
...
<pre><code><b>fun</b> <a href="market.md#0x7_market_emit_event_for_order">emit_event_for_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    // Final check whether <a href="../../libra2-framework/doc/event.md#0x1_event">event</a> sending is enabled
...
<pre><code><b>fun</b> <a href="market.md#0x7_market_place_maker_order_internal">place_maker_order_internal</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    orig_size: u64,
    remaining_size: u64,
    fill_sizes: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    match_count: u32,
    is_bid: bool,
    time_in_force: TimeInForce,
    trigger_condition: Option&lt;TriggerCondition&gt;,
    ...
    <b>return</b> <a href="market.md#0x7_market_OrderMatchResult">OrderMatchResult</a> {
        order_id,
        remaining_size,
        cancel_reason: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_none">option::none</a>(),
        fill_sizes,
        match_count
    }
}
...
<pre><code><b>fun</b> <a href="market.md#0x7_market_cancel_order_internal">cancel_order_internal</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>return</b> <a href="market.md#0x7_market_OrderMatchResult">OrderMatchResult</a> {
        order_id,
        remaining_size: 0,
        cancel_reason: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(cancel_reason),
        fill_sizes,
        match_count
    }
}
...
<pre><code><b>fun</b> <a href="market.md#0x7_market_settle_single_trade">settle_single_trade</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    callbacks: &MarketClearinghouseCallbacks&lt;M&gt;,
    time_in_force: TimeInForce,
    fill_sizes: &<b>mut</b> <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    ...
    <b>if</b> (taker_cancellation_reason.is_some()) {
        ...
        <b>return</b> <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(OrderCancellationReason::ClearinghouseSettleViolation);
    };
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_place_order_with_order_id">place_order_with_order_id</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>if</b> (order_id.is_none()) {
        ...
        order_id = <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(self.<a href="market.md#0x7_market_next_order_id">next_order_id</a>());
    };
    ...
    // TODO(skedia) reconsile the semantics around <b>global</b> order id vs <a href="../../libra2-framework/doc/account.md#0x1_account">account</a> <b>local</b> id.
    ...
    <b>if</b> (
        ...
        <b>return</b> self.<a href="market.md#0x7_market_cancel_order_internal">cancel_order_internal</a>(
            ...
            <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>[],
            0, // match_count
            is_bid,
            is_taker_order, // is_taker
    ...
    <b>let</b> fill_sizes = <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();
    ...
    <b>loop</b> {
        ...
        <b>let</b> is_taker_order =
            self.<a href="order_book.md#0x7_order_book">order_book</a>.<a href="market.md#0x7_market_is_taker_order">is_taker_order</a>(limit_price, is_bid, <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_none">option::none</a>());
        <b>if</b> (!is_taker_order) {
            <b>if</b> (time_in_force == immediate_or_cancel()) {
                <b>return</b> self.<a href="market.md#0x7_market_cancel_order_internal">cancel_order_internal</a>(
                    user_addr,
        ...
        <b>if</b> (match_count &gt;= max_match_limit) {
            <b>if</b> (cancel_on_match_limit) {
                ...
                <b>return</b> <a href="market.md#0x7_market_OrderMatchResult">OrderMatchResult</a> {
                    order_id,
                    remaining_size,
                    cancel_reason: <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(
                        OrderCancellationReason::MaxFillLimitViolation
                    ),
                    fill_sizes,
                    match_count
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_cancel_order_with_client_id">cancel_order_with_client_id</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> order =
        self.<a href="order_book.md#0x7_order_book">order_book</a>.try_cancel_order_with_client_order_id(
            <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(user), client_order_id
        );
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_cancel_order">cancel_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> <a href="../../libra2-framework/doc/account.md#0x1_account">account</a> = <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(user);
    <b>let</b> order = self.<a href="order_book.md#0x7_order_book">order_book</a>.<a href="market.md#0x7_market_cancel_order">cancel_order</a>(<a href="../../libra2-framework/doc/account.md#0x1_account">account</a>, order_id);
    <b>assert</b>!(<a href="../../libra2-framework/doc/account.md#0x1_account">account</a> == order.get_account(), <a href="market.md#0x7_market_ENOT_ORDER_CREATOR">ENOT_ORDER_CREATOR</a>);
...
<pre><code><b>fun</b> <a href="market.md#0x7_market_cancel_order_helper">cancel_order_helper</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    callbacks.cleanup_order(
        <a href="../../libra2-framework/doc/account.md#0x1_account">account</a>, order_id, is_bid, remaining_size
    );
    self.<a href="market.md#0x7_market_emit_event_for_order">emit_event_for_order</a>(
        order_id,
        client_order_id,
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_decrease_order_size">decrease_order_size</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> <a href="../../libra2-framework/doc/account.md#0x1_account">account</a> = <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(user);
    self.<a href="order_book.md#0x7_order_book">order_book</a>.<a href="market.md#0x7_market_decrease_order_size">decrease_order_size</a>(<a href="../../libra2-framework/doc/account.md#0x1_account">account</a>, order_id, size_delta);
    ...
    <b>assert</b>!(order.get_account() == <a href="../../libra2-framework/doc/account.md#0x1_account">account</a>, <a href="market.md#0x7_market_ENOT_ORDER_CREATOR">ENOT_ORDER_CREATOR</a>);
    <b>let</b> (
        user,
        order_id,
        client_order_id,
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_get_order_metadata_by_client_id">get_order_metadata_by_client_id</a>&lt;M: <b>copy</b>, drop, store&gt;(self: &<a href="market.md#0x7_market_Market">market::Market</a>&lt;M&gt;, user: <b>address</b>, client_order_id: u64): <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;M&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_take_ready_price_based_orders">take_ready_price_based_orders</a>&lt;M: <b>copy</b>, drop, store&gt;(self: &<b>mut</b> <a href="market.md#0x7_market_Market">market::Market</a>&lt;M&gt;, oracle_price: u64, order_limit: u64): <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="order_book_types.md#0x7_order_book_types_Order">order_book_types::Order</a>&lt;M&gt;&gt;
</code></pre>
...
): <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;Order&lt;M&gt;&gt; {
...
<pre><code><b>public</b> <b>fun</b> <a href="market.md#0x7_market_take_ready_time_based_orders">take_ready_time_based_orders</a>&lt;M: <b>copy</b>, drop, store&gt;(self: &<b>mut</b> <a href="market.md#0x7_market_Market">market::Market</a>&lt;M&gt;, order_limit: u64): <a href="../../libra2-framework/../libra2-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="order_book_types.md#0x7_order_book_types_Order">order_book_types::Order</a>&lt;M&gt;&gt;
</code></pre>
