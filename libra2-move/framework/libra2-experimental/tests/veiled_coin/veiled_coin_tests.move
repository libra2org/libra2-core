...
module libra2_experimental::veiled_coin_tests {
    #[test_only]
    use std::features;
    #[test_only]
    use std::signer;
    ...
    #[test_only]
    use libra2_experimental::veiled_coin;
    #[test_only]
    use libra2_experimental::helpers::generate_elgamal_keypair;
    #[test_only]
    use libra2_experimental::sigma_protos::{serialize_withdrawal_subproof, prove_withdrawal};
    #[test_only]
    use libra2_experimental::sigma_protos;
