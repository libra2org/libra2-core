/// (work in progress)
module libra2_experimental::order_book_types {
    use std::option;
    use std::option::Option;
    use libra2_framework::big_ordered_map::{Self, BigOrderedMap};
    friend libra2_experimental::active_order_book;
    friend libra2_experimental::order_book;
    friend libra2_experimental::pending_order_book_index;
    friend libra2_experimental::market;
