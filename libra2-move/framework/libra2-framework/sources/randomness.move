/// This module provides access to *instant* secure randomness generated by the Libra2 validators, as documented in
...
///
/// Security holds under the same proof-of-stake assumption that secures the Libra2 network.
module libra2_framework::randomness {
    ...
    public fun initialize(framework: &signer) {
        ...
        if (!exists<PerBlockRandomness>(@libra2_framework)) {
    ...
    public(friend) fun on_new_block(vm: &signer, epoch: u64, round: u64, seed_for_new_block: Option<vector<u8>>) acquires PerBlockRandomness {
        ...
        if (exists<PerBlockRandomness>(@libra2_framework)) {
            let randomness = borrow_global_mut<PerBlockRandomness>(@libra2_framework);
    ...
    fun next_32_bytes(): vector<u8> acquires PerBlockRandomness {
        ...
        let input = DST;
        let randomness = borrow_global<PerBlockRandomness>(@libra2_framework);
