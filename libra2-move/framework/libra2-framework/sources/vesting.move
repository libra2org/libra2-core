...
module libra2_framework::vesting {
    ...
    public entry fun set_beneficiary(
        ...
        // fail and block all other accounts from receiving LBT if one beneficiary is not registered.
    ...
    fun create_vesting_contract_account(
        ...
        // Register the vesting contract account to receive LBT as it'll be sent to it when claiming unlocked stake from
    ...
    #[test_only]
    const MIN_STAKE: u64 = 100000000000000; // 1M LBT coins with 8 decimals.

    #[test_only]
    const GRANT_AMOUNT: u64 = 20000000000000000; // 200M LBT coins with 8 decimals.
