spec libra2_framework::timestamp {
    /// <high-level-req>
    /// No.: 1
    ...
    spec module {
        ...
        /// [high-level-req-1]
        /// [high-level-req-2]
        invariant [suspendable] chain_status::is_operating() ==> exists<CurrentTimeMicroseconds>(@libra2_framework);
    }
    ...
    spec fun spec_now_microseconds(): u64 {
        global<CurrentTimeMicroseconds>(@libra2_framework).microseconds
    }
