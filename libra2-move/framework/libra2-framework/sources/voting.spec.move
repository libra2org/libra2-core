spec libra2_framework::voting {
    ...
    // CurrentTimeMicroseconds existed under the @libra2_framework.
    ...
    spec resolve_proposal_v2<ProposalType: store>(
        ...
        aborts_if len(next_execution_hash) == 0 && !exists<timestamp::CurrentTimeMicroseconds>(@libra2_framework);
