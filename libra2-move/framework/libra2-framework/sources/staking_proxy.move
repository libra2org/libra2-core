module libra2_framework::staking_proxy {
    use std::error;
    use std::signer;
    use std::vector;
    ...
    #[test_only]
    const INITIAL_BALANCE: u64 = 100000000000000; // 1M LBT_coins with 8 decimals.
    ...
    public entry fun test_set_operator(
        ...
        vesting::setup(
            libra2_framework, &vector[owner_address, operator_1_address, operator_2_address, new_operator_address]);
        staking_contract::setup_staking_contract(libra2_framework, owner, operator_1, INITIAL_BALANCE, 0);
        staking_contract::setup_staking_contract(libra2_framework, owner, operator_2, INITIAL_BALANCE, 0);
    ...
    public entry fun test_set_voter(
        ...
        vesting::setup(
            libra2_framework, &vector[owner_address, operator_1_address, operator_2_address, new_voter_address]);
        staking_contract::setup_staking_contract(libra2_framework, owner, operator_1, INITIAL_BALANCE, 0);
        staking_contract::setup_staking_contract(libra2_framework, owner, operator_2, INITIAL_BALANCE, 0);
