...
module libra2_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::signer;
    ...
    use libra2_framework::code::PackageRegistry;
    use libra2_framework::event;
    use libra2_framework::object;
    use libra2_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"libra2_framework::object_code_deployment";
