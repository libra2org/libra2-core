...
module libra2_framework::staking_config {
    use std::error;
    use std::features;
    ...
    public(friend) fun initialize(
        ...
        move_to(libra2_framework, StakingConfig {
            minimum_stake,
            maximum_stake,
    ...
    public fun reward_rate(): (u64, u64) acquires StakingRewardsConfig, StakingConfig {
        get_reward_rate(borrow_global<StakingConfig>(@libra2_framework))
    }
    ...
    public fun initialize_rewards(
        ...
        move_to(libra2_framework, StakingRewardsConfig {
            rewards_rate,
            min_rewards_rate,
            rewards_rate_period_in_secs,
    ...
    public fun get(): StakingConfig acquires StakingConfig {
        *borrow_global<StakingConfig>(@libra2_framework)
    }
    ...
    public fun get_reward_rate(config: &StakingConfig): (u64, u64) acquires StakingRewardsConfig {
        if (features::periodical_reward_rate_decrease_enabled()) {
            let epoch_rewards_rate = borrow_global<StakingRewardsConfig>(@libra2_framework).rewards_rate;
    ...
    fun calculate_and_save_latest_rewards_config(): StakingRewardsConfig acquires StakingRewardsConfig {
        let staking_rewards_config = borrow_global_mut<StakingRewardsConfig>(@libra2_framework);
    ...
    public fun update_required_stake(
        ...
        let staking_config = borrow_global_mut<StakingConfig>(@libra2_framework);
    ...
    public entry fun test_change_staking_configs(libra2_framework: signer) acquires StakingConfig {
        initialize_for_test(&libra2_framework, 0, 1, 1, false, 1, 1, 1);
        ...
        update_required_stake(&libra2_framework, 100, 1000);
        update_recurring_lockup_duration_secs(&libra2_framework, 10000);
        update_rewards_rate(&libra2_framework, 10, 100);
        update_voting_power_increase_limit(&libra2_framework, 10);

        let config = borrow_global<StakingConfig>(@libra2_framework);
    ...
    #[test(libra2_framework = @libra2_framework)]
    public entry fun test_staking_rewards_rate_decrease_over_time(libra2_framework: signer) acquires StakingRewardsConfig {
    ...
    #[test(libra2_framework = @libra2_framework)]
    public entry fun test_change_staking_rewards_configs(libra2_framework: signer) acquires StakingRewardsConfig {
        let start_time_in_secs: u64 = 100001000000;
        initialize_rewards_for_test(
            &libra2_framework,
            create_from_rational(1, 100),
        ...
        let config = borrow_global<StakingRewardsConfig>(@libra2_framework);
    ...
    #[test(libra2_framework = @0x1, account = @0x123)]
    #[expected_failure(abort_code = 0x50003, location = libra2_framework::system_addresses)]
    public entry fun test_update_rewards_unauthorized_should_fail(libra2_framework: signer, account: signer) acquires StakingConfig {
        // This test case checks the behavior when the periodical_reward_rate_decrease feature is disabled.
        features::change_feature_flags_for_testing(&libra2_framework, vector[], vector[features::get_periodical_reward_rate_decrease_feature()]);
    ...
    #[test(account = @0x123, libra2_framework = @libra2_framework)]
    #[expected_failure(abort_code = 0x50003, location = libra2_framework::system_addresses)]
    public entry fun test_update_rewards_config_unauthorized_should_fail(account: signer, libra2_framework: signer) acquires StakingRewardsConfig {
    ...
    public entry fun test_update_required_stake_invalid_range_should_fail(libra2_framework: signer) acquires StakingConfig {
        update_required_stake(&libra2_framework, 10, 5);
    }

    #[test(libra2_framework = @libra2_framework)]
    #[expected_failure(abort_code = 0x10003, location = Self)]
    public entry fun test_update_required_stake_zero_max_stake_should_fail(libra2_framework: signer) acquires StakingConfig {
        update_required_stake(&libra2_framework, 0, 0);
    }

    #[test(libra2_framework = @libra2_framework)]
    #[expected_failure(abort_code = 0x10001, location = Self)]
    public entry fun test_update_required_lockup_to_zero_should_fail(libra2_framework: signer) acquires StakingConfig {
        update_recurring_lockup_duration_secs(&libra2_framework, 0);
    }

    #[test(libra2_framework = @libra2_framework)]
    #[expected_failure(abort_code = 0x10002, location = Self)]
    public entry fun test_update_rewards_invalid_denominator_should_fail(libra2_framework: signer) acquires StakingConfig {
        // This test case checks the behavior when the periodical_reward_rate_decrease feature is disabled.
        features::change_feature_flags_for_testing(&libra2_framework, vector[], vector[features::get_periodical_reward_rate_decrease_feature()]);
        update_rewards_rate(&libra2_framework, 1, 0);
    }

    #[test(libra2_framework = @libra2_framework)]
    #[expected_failure(abort_code = 0x10005, location = Self)]
    public entry fun test_update_rewards_config_rewards_rate_greater_than_1_should_fail(libra2_framework: signer) acquires StakingRewardsConfig {
        let start_time_in_secs: u64 = 100001000000;
        initialize_rewards_for_test(
            &libra2_framework,
    ...
    public entry fun test_update_rewards_config_invalid_rewards_rate_decrease_rate_should_fail(libra2_framework: signer) acquires StakingRewardsConfig {
        let start_time_in_secs: u64 = 100001000000;
        initialize_rewards_for_test(
            &libra2_framework,
            create_from_rational(15981, 1000000000),
    ...
    public entry fun test_update_rewards_config_cannot_change_rewards_rate_period(libra2_framework: signer) acquires StakingRewardsConfig {
        let start_time_in_secs: u64 = 100001000000;
        initialize_rewards_for_test(
            &libra2_framework,
            create_from_rational(15981, 1000000000),
    ...
    public entry fun test_feature_flag_disabled_get_epoch_rewards_rate_should_fail(libra2_framework: signer) acquires StakingRewardsConfig {
        features::change_feature_flags_for_testing(&libra2_framework, vector[], vector[features::get_periodical_reward_rate_decrease_feature()]);
    ...
    public entry fun test_update_voting_power_increase_limit_to_zero_should_fail(
        ...
        // This test case checks the behavior when the periodical_reward_rate_decrease feature is disabled.
        features::change_feature_flags_for_testing(&libra2_framework, vector[], vector[features::get_periodical_reward_rate_decrease_feature()]);
        update_voting_power_increase_limit(&libra2_framework, 0);
    }

    #[test(libra2_framework = @libra2_framework)]
    #[expected_failure(abort_code = 0x10004, location = libra2_framework::staking_config)]
    public entry fun test_update_voting_power_increase_limit_to_more_than_upper_bound_should_fail(
        libra2_framework: signer
    ) acquires StakingConfig {
        update_voting_power_increase_limit(&libra2_framework, 51);
    }
    ...
    public fun initialize_for_test(
        ...
        if (!exists<StakingConfig>(@libra2_framework)) {
            move_to(libra2_framework, StakingConfig {
                minimum_stake,
                maximum_stake,
                recurring_lockup_duration_secs,
