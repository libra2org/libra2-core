...
module libra2_framework::optional_aggregator {
    use std::error;
    ...
    #[test(account = @libra2_framework)]
    #[expected_failure(abort_code = 0x020001, location = libra2_framework::aggregator)]
    ...
    #[test(account = @libra2_framework)]
    #[expected_failure(abort_code = 0x020002, location = libra2_framework::aggregator)]
