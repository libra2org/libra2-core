...
module libra2_framework::code {
    ...
    friend libra2_framework::object_code_deployment;
    ...
    fun initialize(libra2_framework: &signer, package_owner: &signer, metadata: PackageMetadata)
