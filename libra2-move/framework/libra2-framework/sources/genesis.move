module libra2_framework::genesis {
    ...
    use libra2_framework::nonce_validation;
    ...
    fun initialize(
        ...
        stake::initialize_pending_transaction_fee(&libra2_framework_account);
    ...
    fun initialize_core_resources_and_libra2_coin(
        ...
        libra2_account::register_apt(&core_resources); // registers LBT_store
    ...
    fun create_account(libra2_framework: &signer, account_address: address, balance: u64): signer {
        ...
        if (coin::balance<Libra2Coin>(account_address) == 0) {
