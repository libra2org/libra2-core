...
module libra2_framework::libra2_governance {
    ...
    public fun get_remaining_voting_power(
        ...
        let used_voting_power = *VotingRecordsV2[@libra2_framework].votes.borrow_with_default(record_key, &0);
    ...
    fun vote_internal(
        ...
        let used_voting_power = VotingRecordsV2[@libra2_framework].votes.borrow_mut_with_default(record_key, 0);
        ...
        *used_voting_power += voting_power;
        ...
        if (std::features::module_event_migration_enabled()) {
            ...
            let events = &mut GovernanceEvents[@libra2_framework];
            event::emit_event(
