...
module libra2_framework::delegation_pool {
    ...
    public entry fun test_add_stake_fee(
        ...
        assert_delegation(delegator1_address, pool_address, delegator1_active + 10000 * ONE_LBT - fee, 0, 0);
        ...
        assert_delegation(delegator1_address, pool_address, delegator1_active + 20000 * ONE_LBT - fee, 0, 0);

        // delegator 1 unlocks his entire newly added stake
        unlock(delegator1, pool_address, 20000 * ONE_LBT - fee);
        end_libra2_epoch();
        ...
        assert_delegation(
            delegator1_address,
            pool_address,
            delegator1_active + 20000 * ONE_LBT - fee,
            0,
    ...
    public entry fun test_add_stake_single(
        ...
        assert_delegation(validator_address, pool_address, 1500 * ONE_LBT - fee1, 0, 0);
        ...
        assert_delegation(validator_address, pool_address, 1600 * ONE_LBT - fee1 - fee2, 0, 0);
        // check `add_stake` fee has been transferred to the null shareholder
    ...
    public entry fun test_add_stake_many(
        ...
        let fee1 = get_add_stake_fee(pool_address, 250 * ONE_LBT);
        assert_delegation(delegator_address, pool_address, 250 * ONE_LBT - fee1, 0, 0);
        assert_delegation(validator_address, pool_address, 1000 * ONE_LBT, 0, 0);
        ...
        let fee2 = get_add_stake_fee(pool_address, 100 * ONE_LBT);
        assert_delegation(delegator_address, pool_address, 350 * ONE_LBT - fee2, 0, 0);
        assert_delegation(validator_address, pool_address, 125999999999 - fee1, 0, 0);
    ...
    public entry fun test_unlock_single(
        ...
        assert_delegation(validator_address, pool_address, 300 * ONE_LBT - fee, 0, 0);
        ...
        unlock(validator, pool_address, 100 * ONE_LBT);
        assert_delegation(validator_address, pool_address, 200 * ONE_LBT - fee, 0, 100 * ONE_LBT);
        ...
        assert_delegation(validator_address, pool_address, 250 * ONE_LBT - fee, 0, 50 * ONE_LBT);
        ...
        end_libra2_epoch(); // additionally forwards EPOCH_DURATION seconds
        ...
        end_libra2_epoch(); // additionally forwards EPOCH_DURATION seconds and expires lockup cycle
    ...
    public entry fun test_reactivate_stake_single(
        ...
        assert_delegation(validator_address, pool_address, 250 * ONE_LBT - fee, 0, 100 * ONE_LBT);
        ...
        assert_delegation(validator_address, pool_address, 350 * ONE_LBT - fee, 0, 0);
    ...
    public entry fun test_active_stake_rewards(
        ...
        let fee = get_add_stake_fee(pool_address, 200 * ONE_LBT);
        assert_delegation(validator_address, pool_address, 1210 * ONE_LBT - fee, 0, 0);
    ...
    public entry fun test_active_stake_rewards_multiple(
        ...
        assert_delegation(delegator_address, pool_address, 300 * ONE_LBT - fee, 0, 0);
    ...
    public entry fun test_pending_inactive_stake_rewards(
        ...
        end_libra2_epoch(); // 81810000001 active stake * 1.01 + 20199999998 pending_inactive stake * 1.01

        timestamp::fast_forward_seconds(LOCKUP_CYCLE_SECONDS);
        end_libra2_epoch(); // 82628100001 active stake * 1.01 + 20401999997 pending_inactive stake * 1.01
        end_libra2_epoch(); // 83454381001 active stake * 1.01 + 20606019996 pending_inactive stake(now inactive)
        ...
        end_libra2_epoch(); // 64288924812 active stake * 1.01 + 19999999999 pending_inactive stake * 1.01
        end_libra2_epoch(); // 64931814060 active stake * 1.01 + 20199999998 pending_inactive stake * 1.01
        end_libra2_epoch(); // 65581132200 active stake * 1.01 + 20401999997 pending_inactive stake * 1.01
        end_libra2_epoch(); // 66236943522 active stake * 1.01 + 20606019996 pending_inactive stake * 1.01
        assert_delegation(validator_address, pool_address, 66899312957, 0, 20812080195);

        timestamp::fast_forward_seconds(LOCKUP_CYCLE_SECONDS);
        end_libra2_epoch(); // 66899312957 active stake * 1.01 + 20812080195 pending_inactive stake * 1.01
        end_libra2_epoch(); // 67568306086 active stake * 1.01 + 21020200996 pending_inactive stake(now inactive)
        end_libra2_epoch(); // 68243989147 active stake * 1.01 + 21020200996 inactive stake
    ...
    public entry fun test_operator_fee(
        ...
        unlock(delegator2, pool_address, 100 * ONE_LBT);
        // 10807241561 - 100 LBT < `MIN_COINS_ON_SHARES_POOL` thus active stake is entirely unlocked
    ...
    public entry fun test_set_beneficiary_for_operator(
        ...
        assert!(coin::balance<Libra2Coin>(operator1_address) == ONE_LBT - 1, 0);
        ...
        assert!(coin::balance<Libra2Coin>(beneficiary_address) == ONE_LBT - 1, 0);
        assert!(coin::balance<Libra2Coin>(operator1_address) == ONE_LBT - 1, 0);
        ...
        assert!(coin::balance<Libra2Coin>(beneficiary_address) == ONE_LBT - 1, 0);
        assert!(coin::balance<Libra2Coin>(operator2_address) == ONE_LBT - 1, 0);
    }
    ...
    public entry fun test_delegate_voting_power_applies_next_lockup(
        ...
        assert!(
            calculate_and_update_voter_total_voting_power(
                pool_address,
                delegator_address
            ) == 20 * ONE_LBT - get_add_stake_fee(pool_address, 20 * ONE_LBT),
            0
        );
        ...
        assert!(
            calculate_and_update_voter_total_voting_power(
                pool_address,
                voter1_address
            ) == 20 * ONE_LBT + 30 * ONE_LBT - get_add_stake_fee(pool_address, 30 * ONE_LBT),
            0
        );
    ...
    public entry fun test_delegation_pool_allowlisting_e2e(
        ...
        assert_delegation(delegator_1_address, pool_address, 20 * ONE_LBT + 5223120049, 0, 10 * ONE_LBT);
