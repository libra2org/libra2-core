...
module libra2_framework::timestamp {
    ...
    public(friend) fun set_time_has_started(libra2_framework: &signer) {
        ...
        move_to(libra2_framework, timer);
    }
    ...
    public fun set_time_has_started_for_testing(account: &signer) {
        if (!exists<CurrentTimeMicroseconds>(@libra2_framework)) {
    ...
    public fun now_microseconds(): u64 acquires CurrentTimeMicroseconds {
        borrow_global<CurrentTimeMicroseconds>(@libra2_framework).microseconds
    }
