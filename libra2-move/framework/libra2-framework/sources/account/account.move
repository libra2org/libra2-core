module libra2_framework::account {
    ...
    #[test_only]
    /// Create signer for testing, independently of an Libra2-style `Account`.
    ...
    public fun originating_address(auth_key: address): Option<address> acquires OriginatingAddress {
        let address_map_ref = &OriginatingAddress[@libra2_framework].address_map;
    ...
    entry fun set_originating_address(_account: &signer) acquires Account, OriginatingAddress {
        ...
        let address_map_ref_mut =
            &mut OriginatingAddress[@libra2_framework].address_map;
    ...
    fun update_auth_key_and_originating_address_table(
        ...
        let address_map = &mut OriginatingAddress[@libra2_framework].address_map;
    ...
    /// `create_account` to attempt to claim an account ahead of the creation of a resource account, if found Libra2 will
    ...
    public entry fun test_valid_rotate_authentication_key_multi_ed25519_to_multi_ed25519(
        ...
        let address_map = &OriginatingAddress[@libra2_framework].address_map;
