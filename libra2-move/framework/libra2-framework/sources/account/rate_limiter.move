module libra2_framework::rate_limiter {
    ...
    fun test_initialize_bucket(libra2_framework: &signer) {
    ...
    #[test(libra2_framework = @0x1)]
    fun test_request_success(libra2_framework: &signer) {
        timestamp::set_time_has_started_for_testing(libra2_framework);
    ...
    #[test(libra2_framework = @0x1)]
    fun test_request_failure(libra2_framework: &signer) {
        timestamp::set_time_has_started_for_testing(libra2_framework);
        let bucket = initialize(10, 30);
    ...
    #[test(libra2_framework = @0x1)]
    fun test_refill(libra2_framework: &signer) {
        timestamp::set_time_has_started_for_testing(libra2_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(libra2_framework= @0x1)]
    fun test_fractional_accumulation(libra2_framework: &signer) {
        timestamp::set_time_has_started_for_testing(libra2_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(libra2_framework= @0x1)]
    fun test_multiple_refills(libra2_framework: &signer) {
        timestamp::set_time_has_started_for_testing(libra2_framework);
        let bucket = initialize(10, 60);
