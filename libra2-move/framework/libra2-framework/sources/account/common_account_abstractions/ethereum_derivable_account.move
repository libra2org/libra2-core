...
module libra2_framework::ethereum_derivable_account {
    ...
    use std::string::utf8;
    #[test_only]
    use libra2_framework::auth_data::{create_derivable_auth_data};
    #[test_only]
    ...
    fun test_construct_message(framework: &signer) {
        ...
        let ethereum_address = b"0xC7B576Ead6aFb962E2DEcB35814FB29723AEC98a";
        let domain = b"localhost:3001";
        let entry_function_name = b"0x1::libra2_account::transfer";
