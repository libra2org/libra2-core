module libra2_framework::common_account_abstractions_utils {
    use std::chain_id;
    use std::string_utils;
    use std::transaction_context::{Self, EntryFunctionPayload};

    friend libra2_framework::ethereum_derivable_account;
    friend libra2_framework::solana_derivable_account;
