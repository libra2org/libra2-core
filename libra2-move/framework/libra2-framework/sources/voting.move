...
/// On-chain governance of the Libra2 network also uses Voting.
///
/// The voting flow:
/// 1. The Voting module can be deployed at a known address (e.g. 0x1 for Libra2 on-chain governance)
/// 2. The governance module, e.g. Libra2Governance, can be deployed later and define a GovernanceProposal resource type
...
module libra2_framework::voting {
    ...
    #[test(libra2_framework = @libra2_framework, governance = @0x123)]
    public entry fun test_voting_passed(libra2_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_generic(libra2_framework, governance, false, false);
    }

    #[test(libra2_framework = @libra2_framework, governance = @0x123)]
    public entry fun test_voting_passed_multi_step(libra2_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_generic(libra2_framework, governance, true, true);
    }
    ...
    public entry fun test_voting_passed_multi_step_cannot_use_single_step_resolve_function(
        ...
        test_voting_passed_generic(libra2_framework, governance, true, false);
    }
    ...
    public entry fun test_voting_passed_single_step_can_use_generic_function(
        ...
        test_voting_passed_generic(libra2_framework, governance, false, true);
    }
    ...
    public entry fun test_cannot_resolve_twice(libra2_framework: &signer, governance: &signer) acquires VotingForum {
        test_cannot_resolve_twice_generic(libra2_framework, governance, false);
    }
    ...
    public entry fun test_cannot_resolve_twice_multi_step(
        ...
        test_cannot_resolve_twice_generic(libra2_framework, governance, true);
    }
    ...
    #[test(libra2_framework = @libra2_framework, governance = @0x123)]
    public entry fun test_voting_passed_early(libra2_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_early_generic(libra2_framework, governance, false);
    }
    ...
    public entry fun test_voting_passed_early_multi_step(
        ...
        test_voting_passed_early_generic(libra2_framework, governance, true);
    }
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail(
        ...
        test_voting_passed_early_in_same_tx_should_fail_generic(libra2_framework, governance, false);
    }
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail_multi_step(
        ...
        test_voting_passed_early_in_same_tx_should_fail_generic(libra2_framework, governance, true);
    }
    ...
    public entry fun test_voting_failed(libra2_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_generic(libra2_framework, governance, false);
    }

    #[test(libra2_framework = @libra2_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002, location = Self)]
    public entry fun test_voting_failed_multi_step(libra2_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_generic(libra2_framework, governance, true);
    }
    ...
    #[test(libra2_framework = @libra2_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002, location = Self)]
    public entry fun test_voting_failed_early(libra2_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_early_generic(libra2_framework, governance, true);
    }
    ...
    public entry fun test_voting_failed_early_multi_step(
        ...
        test_voting_failed_early_generic(libra2_framework, governance, false);
    }
    ...
    public entry fun test_cannot_set_min_threshold_higher_than_early_resolution(
        ...
        test_cannot_set_min_threshold_higher_than_early_resolution_generic(libra2_framework, governance, false);
    }
    ...
    public entry fun test_cannot_set_min_threshold_higher_than_early_resolution_multi_step(
        ...
        test_cannot_set_min_threshold_higher_than_early_resolution_generic(libra2_framework, governance, true);
    }

    #[test(libra2_framework = @libra2_framework, governance = @0x123)]
    public entry fun test_replace_execution_hash(libra2_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@libra2_framework);
        timestamp::set_time_has_started_for_testing(libra2_framework);
