spec libra2_framework::staking_proxy {
    ...
    /// Enforcement: Enforced via [https://github.com/libra2org/libra2-core/blob/main/libra2-move/framework/libra2-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
