spec libra2_framework::staking_proxy {
    ...
    /// Enforcement: Enforced via [https://github.com/aptos-labs/aptos-core/blob/main/libra2-move/framework/libra2-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
