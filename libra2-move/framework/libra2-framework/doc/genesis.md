...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize">initialize</a>(
    ...
    <a href="stake.md#0x1_stake_initialize_pending_transaction_fee">stake::initialize_pending_transaction_fee</a>(&libra2_framework_account);
    ...
    <a href="nonce_validation.md#0x1_nonce_validation_initialize">nonce_validation::initialize</a>(&libra2_framework_account);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_core_resources_and_libra2_coin">initialize_core_resources_and_libra2_coin</a>(
    ...
    <a href="libra2_account.md#0x1_libra2_account_register_apt">libra2_account::register_apt</a>(&core_resources); // registers LBT store
