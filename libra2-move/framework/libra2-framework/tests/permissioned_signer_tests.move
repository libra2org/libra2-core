#[test_only]
module libra2_framework::permissioned_signer_tests {
    use std::bcs;
    use std::features;
    ...
    fun test_permission_e2e(creator: &signer) {
        let libra2_framework = create_signer_for_test(@0x1);
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50005, location = libra2_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50002, location = libra2_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50001, location = libra2_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50007, location = libra2_framework::permissioned_signer
    )]
    ...
    #[expected_failure(
        abort_code = 0x50008, location = libra2_framework::permissioned_signer
    )]
