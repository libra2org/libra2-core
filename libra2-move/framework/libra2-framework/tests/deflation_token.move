...
module 0xcafe::deflation_token {
    use libra2_framework::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    use libra2_framework::dispatchable_fungible_asset;
    use libra2_framework::object::{ConstructorRef, Object};
    ...
    #[test_only]
    use libra2_framework::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status=4037, location=libra2_framework::dispatchable_fungible_asset)]
