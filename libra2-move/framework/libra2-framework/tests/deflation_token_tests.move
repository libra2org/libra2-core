...
module 0xcafe::deflation_token_tests {
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001C, location = libra2_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x8001D, location = libra2_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x10019, location = libra2_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001A, location = libra2_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001B, location = libra2_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(major_status=1081, location = libra2_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=2, location = libra2_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=0x6001E, location = libra2_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x50008, location = libra2_framework::fungible_asset)]
