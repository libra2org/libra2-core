...
pub fn create_proposal_v2(
    ...
    harness.run_transaction_payload(
        account,
        libra2_stdlib::libra2_governance_create_proposal_v2(
            stake_pool,
            execution_hash,
            metadata_location,
            metadata_hash,
...
pub fn partial_vote(
    ...
    harness.run_transaction_payload(
        account,
        libra2_stdlib::libra2_governance_partial_vote(
            stake_pool,
            proposal_id,
            voting_power,
            should_pass,
...
pub fn get_remaining_voting_power(
    ...
    let fun = MemberId::from_str("0x1::libra2_governance::get_remaining_voting_power").unwrap();
    let res = harness
