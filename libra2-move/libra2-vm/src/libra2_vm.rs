...
use crate::{
    ...
    move_vm_ext::{
        ...
        Libra2MoveResolver, MoveVmExt, SessionExt, SessionId, UserTransactionContext,
    },
...
use libra2_framework::natives::code::PublishRequest;
...
use libra2_vm_types::{
    ...
    module_and_script_storage::{
        code_storage::Libra2CodeStorage, module_storage::Libra2ModuleStorage, AsLibra2CodeStorage,
    },
...
impl Libra2VM {
    ...
    pub fn new(env: &Libra2Environment, state_view: &impl StateView) -> Self {
        ...
        let module_storage = state_view.as_libra2_code_storage(env);
    ...
    fn validate_and_execute_script<'a>(
        &self,
        session: &mut SessionExt<impl Libra2MoveResolver>,
        serialized_signers: &SerializedSigners,
    ...
    fn execute_user_transaction_impl(
        ...
        let should_create_account_resource_timer =
            VM_TIMER.timer_with_label("Libra2VM::create_account_resource_lazily");
    ...
    pub fn execute_user_transaction_with_custom_gas_meter<'a, C, G, F>(
        &self,
        resolver: &'a impl Libra2MoveResolver,
        code_storage: &'a C,
        txn: &SignedTransaction,
        log_context: &AdapterLogSchema,
        make_gas_meter: F,
...
pub struct Libra2VMBlockExecutor {
    ...
    module_cache_manager: Libra2ModuleCacheManager,
}
...
impl VMBlockExecutor for Libra2VMBlockExecutor {
    fn new() -> Self {
        Self {
            module_cache_manager: Libra2ModuleCacheManager::new(),
        }
    }
...
pub struct Libra2SimulationVM;

impl Libra2SimulationVM {
