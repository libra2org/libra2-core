...
use crate::{
    ...
    move_vm_ext::{
        session::view_with_change_set::ExecutorViewWithChangeSet, Libra2MoveResolver, SessionExt,
        SessionId,
    },
    Libra2VM,
};
use libra2_types::transaction::user_transaction_context::UserTransactionContext;
use libra2_vm_types::{change_set::VMChangeSet, storage::change_set_configs::ChangeSetConfigs};
...
impl<'r> RespawnedSession<'r> {
    pub fn spawn(
        ...
        base: &'r impl Libra2MoveResolver,
