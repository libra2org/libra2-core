...
use crate::move_vm_ext::{
    resource_state_key, Libra2MoveResolver, AsExecutorView, AsResourceGroupView,
...
use libra2_vm_environment::gas::get_gas_feature_version;
use libra2_vm_types::{
    resolver::{
...
/// Adapter to convert a `ExecutorView` into a `Libra2MoveResolver`.
///
...
impl<E: ExecutorView> Libra2MoveResolver for StorageAdapter<'_, E> {}
...
/// Converts `StateView` into `Libra2MoveResolver`.
