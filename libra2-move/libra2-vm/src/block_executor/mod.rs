...
#[derive(Debug)]
pub struct Libra2TransactionOutput {
...
impl BlockExecutorTransactionOutput for Libra2TransactionOutput {
    ...
    > AptosBlockExecutorWrapper<E>
{
    pub fn execute_block_on_thread_pool<
        S: StateView + Sync,
        L: TransactionCommitHook<Output = Libra2TransactionOutput>,
