...
use libra2_gas_schedule::{gas_feature_versions::RELEASE_V1_30, VMGasParameters};
use libra2_types::{
...
pub trait Libra2GasMeter: MoveGasMeter {
    ...
    ///
    /// Since the fee is measured in LBT/Octa, it needs to be converted into gas units
