...
use crate::{
    code_cache_global_manager::Libra2ModuleCacheManagerGuard,
    combinatorial_tests::{
...
///
/// # Arguments
/// * `guard` - The Libra2ModuleCacheManagerGuard to populate with empty modules
...
pub(crate) fn populate_guard_with_modules(
    guard: &mut Libra2ModuleCacheManagerGuard<'_>,
    module_ids: &[ModuleId],
) {
...
{
    let mut guard = Libra2ModuleCacheManagerGuard::none();
