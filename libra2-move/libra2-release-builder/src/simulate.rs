...
use libra2_transaction_simulation::{DeltaStateStore, SimulationStateStore};
use libra2_types::{
...
use libra2_vm::{data_cache::AsMoveResolver, move_vm_ext::SessionId, Libra2VM};
use libra2_vm_environment::environment::Libra2Environment;
use libra2_vm_logging::log_schema::AdapterLogSchema;
use libra2_vm_types::{
    module_and_script_storage::AsLibra2CodeStorage, module_write_set::ModuleWriteSet,
...
pub async fn simulate_multistep_proposal(
    ...
    let mut client_builder = Client::builder(Libra2BaseUrl::Custom(remote_url));
    ...
    let balance = 100 * 1_0000_0000; // 100 LBT
        ...
        proposal_scripts.iter().zip(compiled_scripts).enumerate()
    {
        ...
        patch_libra2_governance(&state_view, forbid_next_execution_hash)
