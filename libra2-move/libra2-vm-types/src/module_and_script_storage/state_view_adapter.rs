...
pub struct Libra2CodeStorageAdapter<'ctx, S, E> {
...
impl<S, E> Libra2CodeStorageAdapter<'_, S, E>
where
    S: StateView,
    E: WithRuntimeEnvironment,
{
...
impl<S: StateView, E: WithRuntimeEnvironment> Libra2ModuleStorage
    for Libra2CodeStorageAdapter<'_, S, E>
{
...
pub trait AsLibra2CodeStorage<'ctx, S, E> {
    fn as_libra2_code_storage(
        &'ctx self,
        environment: &'ctx E,
    ) -> Libra2CodeStorageAdapter<'ctx, S, E>;
}

impl<'ctx, S, E> AsLibra2CodeStorage<'ctx, S, E> for S
where
    S: StateView,
    E: WithRuntimeEnvironment,
{
    fn as_libra2_code_storage(
        ...
        Libra2CodeStorageAdapter { storage }
    }
}
