...
module example_addr::managed_fungible_asset {
    use libra2_framework::fungible_asset::{Self, MintRef, TransferRef, BurnRef, Metadata, FungibleStore, FungibleAsset};
    use libra2_framework::object::{Self, Object, ConstructorRef};
    ...
    #[test_only]
    use libra2_framework::object::object_from_constructor_ref;
    #[test_only]
    use std::string::utf8;
    use std::vector;
    ...
    fun create_test_mfa(creator: &signer): Object<Metadata> {
        let constructor_ref = &object::create_named_object(creator, b"LBT");
        initialize(
            constructor_ref,
            0,
