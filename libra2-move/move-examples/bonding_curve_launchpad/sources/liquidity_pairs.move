module bonding_curve_launchpad::liquidity_pairs {
    ...
    public(friend) fun register_liquidity_pair(
        ...
        // generator signers from, for when LBT_or the FA needs to be transferred to and from the liquidity pair.
        ...
        // Initial LBT_reserves are virtual liquidity, for less extreme initial swaps (avoiding early adopter's
    ...
    public(friend) fun swap_fa_to_apt(
        ...
        // Perform the swap.
        // Swapper sends FA to the liquidity pair object. The liquidity pair object sends LBT_to the swapper, in return.
    ...
    /// Facilitate swapping between LBT_to a given FA.
    public(friend) fun swap_apt_to_fa(
        ...
        // Perform the swap.
        // Swapper sends LBT_to the liquidity pair object. The liquidity pair object sends FA to the swapper, in return.
        ...
        // Check for graduation requirements. The LBT_reserves must be above the pre-defined
    ...
    fun add_liquidity_coin_entry_transfer_ref<CoinType>(
        ...
        // Wrap LBT_into a FA. Then, determine the optimal amounts for providing liquidity to the given FA - LBT_pair.
        ...
        // Retrieve the LBT_and FA from the liquidity provider.
        ...
        // Place the LBT_and FA into the liquidity pair.
