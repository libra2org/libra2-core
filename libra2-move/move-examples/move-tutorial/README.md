---
title: "Libra2 Move Tutorial"
slug: "move-tutorial"
---

# Move Tutorial

Welcome to the Libra2 Move Tutorial! This is the original Move language and tools tutorial, independent of a particular network, adapted to use Libra2 tooling. Here you will learn basic usage of the Move language and tools for compiling, testing, and verifying Move.

This tutorial does not teach you how to use the existing [Libra2 Move frameworks](https://aptos.dev/reference/move) or how to run code on the Libra2 network. See the [Libra2 developer documentation](https://aptos.dev/tutorials/) for those instructions.
...
> NOTE: The coin and balance interfaces are for illustration of Move concepts only. Libra2 uses a different, richer [coin type](https://aptos.dev/reference/move?branch=mainnet&page=libra2-framework/doc/coin.md) contained in the Libra2 framework.
...
Read more about [phantom type](https://docs.libra2.org/move/book/generics#phantom-type-parameters) parameters in the Libra2 Move Book.
</details>

## Step 7:  Use the Move Prover
    
> NOTE: Before running the Move Prover, ensure that the [Move Prover](https://docs.libra2.org/tools/libra2-cli/install-cli/install-move-prover) and associated tools are installed.
