...
impl From<libra2_secure_storage::Error> for Error {
    fn from(error: libra2_secure_storage::Error) -> Self {
        match error {
            libra2_secure_storage::Error::PermissionDenied => {
            ...
            libra2_secure_storage::Error::KeyVersionNotFound(_, _)
            | libra2_secure_storage::Error::KeyNotSet(_) => {
