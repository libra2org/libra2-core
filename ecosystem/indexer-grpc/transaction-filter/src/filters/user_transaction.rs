...
impl From<UserTransactionFilter> for libra2_protos::indexer::v1::UserTransactionFilter {
...
impl From<EntryFunctionFilter> for libra2_protos::indexer::v1::EntryFunctionFilter {
...
impl From<UserTransactionPayloadFilter>
    for libra2_protos::indexer::v1::UserTransactionPayloadFilter
{
