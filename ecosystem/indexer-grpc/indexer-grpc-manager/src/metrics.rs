...
pub static FILE_STORE_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_file_store_version",
...
pub static FILE_STORE_VERSION_IN_CACHE: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_file_store_version_in_cache",
...
pub static FILE_STORE_UPLOADED_BYTES: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "libra2_indexer_grpc_v2_file_store_uploaded_bytes",
...
pub static IS_MASTER: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_is_master",
...
pub static IS_FILE_STORE_LAGGING: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_is_file_store_lagging",
...
pub static CACHE_SIZE: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_cache_size",
...
pub static MAX_CACHE_SIZE: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_max_cache_size",
...
pub static TARGET_CACHE_SIZE: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_target_cache_size",
...
pub static CACHE_START_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_grpc_manager_cache_start_version",
...
pub static CACHE_END_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_grpc_manager_cache_end_version",
...
pub static KNOWN_LATEST_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "libra2_indexer_grpc_v2_grpc_manager_known_latest_version",
...
pub static CONNECTED_INSTANCES: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        "libra2_indexer_grpc_v2_grpc_manager_connected_instances",
...
pub static COUNTER: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "libra2_indexer_grpc_v2_grpc_manager_counter",
...
pub static TIMER: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "libra2_indexer_grpc_v2_grpc_manager_timer",
