The Libra2 Core project has adopted a Code of Conduct that we expect project participants to adhere to. Please read the following so that you can understand what actions will and will not be tolerated.
