module poc::verify_batch_range_proof_internal {
    use libra2_std::ristretto255_bulletproofs::{Self, range_proof_from_bytes};
    use libra2_std::ristretto255::{RistrettoPoint, new_compressed_point_from_bytes, point_decompress, basepoint, hash_to_point_base};
    use std::option::{Self};
