...
NODE_CONFIG_MOUNT_NAME: str = "libra2-config"
NODE_CONFIG_MOUNT_PATH: str = "/opt/libra2/etc"
GENESIS_ARTIFACTS_MOUNT_NAME: str = "genesis-config"
GENESIS_ARTIFACTS_MOUNT_PATH: str = "/opt/libra2/genesis"
NODE_IDENTITY_MOUNT_NAME: str = "aptos-secret"
NODE_IDENTITY_MOUNT_PATH: str = "/opt/libra2/identites"
...
LIBRA2_DATA_DIR: str = "/opt/libra2/data"
