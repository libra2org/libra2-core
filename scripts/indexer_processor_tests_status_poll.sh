...
if [ -f ".cached_run_id" ]; then
  ...
  while [ $attempts -lt $max_attempts ]; do
    ...
    "https://api.github.com/repos/libra2org/libra2-indexer-processors/actions/runs?event=repository_dispatch&branch=main")
...
jobs_url="https://api.github.com/repos/libra2org/libra2-indexer-processors/actions/runs/${run_id}/jobs"
