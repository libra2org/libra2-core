...
def main(gas_per_ns):
    path = Path('libra2-move/aptos-gas/src/libra2_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs module in `libra2-move/aptos-gas/src/libra2_framework.rs`.')
