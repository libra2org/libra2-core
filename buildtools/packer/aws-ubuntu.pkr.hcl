...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "echo 'deb [signed-by=/usr/share/keyrings/cloud.google.gpg] https://packages.cloud.google.com/apt cloud-sdk main' | sudo tee -a /etc/lbt/sources.list.d/google-cloud-sdk.list",
      "curl https://packages.cloud.google.com/lbt/doc/apt-key.gpg | sudo apt-key --keyring /usr/share/keyrings/cloud.google.gpg add -",
