...
export const GrpcManagerService = {
  heartbeat: {
    path: "/libra2.indexer.v1.GrpcManager/Heartbeat",
    requestStream: false,
  ...
  getTransactions: {
    path: "/libra2.indexer.v1.GrpcManager/GetTransactions",
    requestStream: false,
    responseStream: false,
  ...
  getDataServiceForRequest: {
    path: "/libra2.indexer.v1.GrpcManager/GetDataServiceForRequest",
    requestStream: false,
    responseStream: false,
...
export const DataServiceService = {
  ping: {
    path: "/libra2.indexer.v1.DataService/Ping",
    requestStream: false,
    responseStream: false,
  ...
  getTransactions: {
    path: "/libra2.indexer.v1.DataService/GetTransactions",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: GetTransactionsRequest) => Buffer.from(GetTransactionsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetTransactionsRequest.decode(value),
