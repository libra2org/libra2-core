...
impl serde::Serialize for Transaction {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("libra2.bigquery_schema.transaction.v1.Transaction", len)?;
...
impl<'de> serde::Deserialize<'de> for Transaction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct libra2.bigquery_schema.transaction.v1.Transaction")
            }
        ...
        deserializer.deserialize_struct("libra2.bigquery_schema.transaction.v1.Transaction", FIELDS, GeneratedVisitor)
    }
}
