...
impl serde::Serialize for Timestamp {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("libra2.util.timestamp.Timestamp", len)?;
        if self.seconds != 0 {
...
impl<'de> serde::Deserialize<'de> for Timestamp {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct libra2.util.timestamp.Timestamp")
            }
        ...
        deserializer.deserialize_struct("libra2.util.timestamp.Timestamp", FIELDS, GeneratedVisitor)
    }
}
