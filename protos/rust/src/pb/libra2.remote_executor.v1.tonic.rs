        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn simple_msg_exchange(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/libra2.remote_executor.v1.NetworkMessageService/SimpleMsgExchange",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "libra2.remote_executor.v1.NetworkMessageService",
                        "SimpleMsgExchange",
                    ),
                );
...
pub mod network_message_service_server {
    ...
    pub const SERVICE_NAME: &str = "libra2.remote_executor.v1.NetworkMessageService";
