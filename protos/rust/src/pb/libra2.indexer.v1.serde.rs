...
impl serde::Serialize for ProcessedRange {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("libra2.indexer.v1.ProcessedRange", len)?;
        if self.first_version != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for ProcessedRange {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct libra2.indexer.v1.ProcessedRange")
            }
        ...
        deserializer.deserialize_struct("libra2.indexer.v1.ProcessedRange", FIELDS, GeneratedVisitor)
    }
}
