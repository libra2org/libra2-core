...
*/
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("libra2.indexer.v1.RawData", "GetTransactions"));
...
*/
    ...
    pub const SERVICE_NAME: &str = "libra2.indexer.v1.RawData";
...
pub mod grpc_manager_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/libra2.indexer.v1.GrpcManager/Heartbeat",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("libra2.indexer.v1.GrpcManager", "Heartbeat"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/libra2.indexer.v1.GrpcManager/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("libra2.indexer.v1.GrpcManager", "GetTransactions"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/libra2.indexer.v1.GrpcManager/GetDataServiceForRequest",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "libra2.indexer.v1.GrpcManager",
...
pub mod grpc_manager_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "libra2.indexer.v1.GrpcManager";
...
pub mod data_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/libra2.indexer.v1.DataService/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("libra2.indexer.v1.DataService", "Ping"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn get_transactions(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/libra2.indexer.v1.DataService/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("libra2.indexer.v1.DataService", "GetTransactions"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
    }
...
pub mod data_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "libra2.indexer.v1.DataService";
