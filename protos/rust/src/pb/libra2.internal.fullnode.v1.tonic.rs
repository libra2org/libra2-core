        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/libra2.internal.fullnode.v1.FullnodeData/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("libra2.internal.fullnode.v1.FullnodeData", "Ping"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/libra2.internal.fullnode.v1.FullnodeData/GetTransactionsFromNode",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "libra2.internal.fullnode.v1.FullnodeData",
...
pub mod fullnode_data_server {
    ...
    pub const SERVICE_NAME: &str = "libra2.internal.fullnode.v1.FullnodeData";
