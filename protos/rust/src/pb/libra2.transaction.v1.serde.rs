...
impl serde::Serialize for ExtraConfigV1 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("libra2.transaction.v1.ExtraConfigV1", len)?;
...
impl<'de> serde::Deserialize<'de> for ExtraConfigV1 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct libra2.transaction.v1.ExtraConfigV1")
            }
        ...
        deserializer.deserialize_struct("libra2.transaction.v1.ExtraConfigV1", FIELDS, GeneratedVisitor)
    }
}
