...
impl serde::Serialize for Empty {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("libra2.remote_executor.v1.Empty", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Empty {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct libra2.remote_executor.v1.Empty")
            }
        ...
        deserializer.deserialize_struct("libra2.remote_executor.v1.Empty", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NetworkMessage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("libra2.remote_executor.v1.NetworkMessage", len)?;
        if !self.message.is_empty() {
...
impl<'de> serde::Deserialize<'de> for NetworkMessage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct libra2.remote_executor.v1.NetworkMessage")
            }
        ...
        deserializer.deserialize_struct("libra2.remote_executor.v1.NetworkMessage", FIELDS, GeneratedVisitor)
    }
}
