...
impl<'de> serde::Deserialize<'de> for GetTransactionsFromNodeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("libra2.internal.fullnode.v1.GetTransactionsFromNodeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PingFullnodeRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("libra2.internal.fullnode.v1.PingFullnodeRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PingFullnodeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("libra2.internal.fullnode.v1.PingFullnodeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PingFullnodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("libra2.internal.fullnode.v1.PingFullnodeResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for PingFullnodeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("libra2.internal.fullnode.v1.PingFullnodeResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for StreamStatus {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("libra2.internal.fullnode.v1.StreamStatus", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for TransactionsFromNodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("libra2.internal.fullnode.v1.TransactionsFromNodeResponse", len)?;
        if self.chain_id != 0 {
...
;
        ...
        deserializer.deserialize_struct("libra2.internal.fullnode.v1.TransactionsFromNodeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TransactionsOutput {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("libra2.internal.fullnode.v1.TransactionsOutput", len)?;
        if !self.transactions.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TransactionsOutput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("libra2.internal.fullnode.v1.TransactionsOutput", FIELDS, GeneratedVisitor)
    }
}
