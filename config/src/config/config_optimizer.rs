...
const MAINNET_SEED_PEERS: [(&str, &str, &str); 1] = [(
    ...
    "/dns/node1.cloud-b.mainnet.libra2.org/tcp/6182/noise-ik/0x003cc2ed36e7d486539ac2c411b48d962f1ef17d884c3a7109cad43f16bd5008/handshake/0",
)];
...
const TESTNET_SEED_PEERS: [(&str, &str, &str); 4] = [
    (
        ...
        "/dns/seed0.testnet.libra2.org/tcp/6182/noise-ik/0x87bb19b02580b7e2a91a8e9342ec77ffd8f3ad967f54e77b22aaf558c5c11755/handshake/0",
    ),
    (
        ...
        "/dns/seed1.testnet.libra2.org/tcp/6182/noise-ik/0xc2f24389f31c9c18d2ceb69d153ad9299e0ea7bbd66f457e0a28ef41c77c2b64/handshake/0",
    ),
    (
        ...
        "/dns/seed2.testnet.libra2.org/tcp/6182/noise-ik/0x171c661e5b785283978a74eafc52a906e68c73ae78119737b92f93507c753933/handshake/0",
    ),
    (
        ...
        "/dns/seed3.testnet.libra2.org/tcp/6182/noise-ik/0xafc38bf177bd825326a1c314748612137d2b35dae6472932806806a32c23174a/handshake/0",
    ),
];
                ...
                - network_id: "Public"
                  seeds:
                      bb14af025d226288a3488b4433cf5cb54d6a710365a2d95ac6ffbd9b9198a86a:
                          addresses:
                              - "/dns4/pfn0.node.devnet.libra2.org/tcp/6182/noise-ik/bb14af025d226288a3488b4433cf5cb54d6a710365a2d95ac6ffbd9b9198a86a/handshake/0"
                          role: "Upstream"
            "#,
        )
            .unwrap();
