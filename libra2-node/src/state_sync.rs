...
fn setup_data_streaming_service(
    ...
    // Start the data streaming service
    let streaming_service_runtime = libra2_runtimes::spawn_named_runtime("stream-serv".into(), None);
...
fn setup_libra2_data_client(
    ...
    let libra2_data_client_runtime = libra2_runtimes::spawn_named_runtime("data-client".into(), None);
...
fn setup_state_sync_storage_service(
    ...
    let storage_service_runtime = libra2_runtimes::spawn_named_runtime("stor-server".into(), None);
