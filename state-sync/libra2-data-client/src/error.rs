...
/// An error returned by the Libra2 Data Client for failed API calls.
...
impl From<libra2_storage_service_client::Error> for Error {
    fn from(error: libra2_storage_service_client::Error) -> Self {
