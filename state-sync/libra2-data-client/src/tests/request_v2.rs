...
use crate::{
    ...
    interface::{Libra2DataClientInterface, SubscriptionRequestMetadata},
...
fn create_libra2_data_client(use_request_v2: bool) -> Libra2DataClientConfig {
    Libra2DataClientConfig {
...
fn create_client_with_peer(use_request_v2: bool) -> (MockNetwork, Libra2DataClient, NetworkId) {
    ...
    let data_client_config = create_libra2_data_client(use_request_v2);
