...
pub fn new_storage_service_notifier_listener_pair(
    ...
    let (notification_sender, notification_receiver) = libra2_channel::new(
        QueueStyle::LIFO,
...
pub struct StorageServiceNotifier {
    notification_sender: libra2_channel::Sender<(), StorageServiceCommitNotification>,
}
...
pub struct StorageServiceNotificationListener {
    notification_receiver: libra2_channel::Receiver<(), StorageServiceCommitNotification>,
}
