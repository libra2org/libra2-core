...
pub enum FeatureFlag {
    ...
    PRIMARY_LBT_FUNGIBLE_STORE_AT_USER_ADDRESS = 61,
    OBJECT_NATIVE_DERIVED_ADDRESS = 62,
    DISPATCHABLE_FUNGIBLE_ASSET = 63,
    NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE = 64,
    OPERATIONS_DEFAULT_TO_FA_LBT_STORE = 65,
...
pub fn libra2_test_feature_flags_genesis() -> ChangeSet {
