...
use anyhow::bail;
use libra2_crypto::{poseidon_bn254, poseidon_bn254::pad_and_hash_string, CryptoMaterialError};
...
// TODO(keyless): Some of this stuff, if not all, belongs to the libra2-crypto crate
