...
pub static DST: &[u8] = b"LIBRA_PEPPER_BLS12381_VUF_DST";

pub static PINKAS_DST: &[u8] = b"LIBRA_PINKAS_PEPPER_DST";

pub static PINKAS_SECRET_KEY_BASE_SEED: &[u8] = b"LIBRA_PINKAS_PEPPER_SECRET_KEY_BASE_SEED";
