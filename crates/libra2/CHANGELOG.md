...
## [3.5.0] - 2024/07/06
- Add balance command to easily get account balances for LBT currently
...
- Added `aptos update revela`. This installs / updates the `revela` binary, which is needed for the new `libra2 move decompile` subcommand.
