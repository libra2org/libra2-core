...
/// Add LBT to a stake pool
///
/// This command allows stake pool owners to add LBT to their stake.
#[derive(Parser)]
pub struct AddStake {
...
/// Unlock staked LBT in a stake pool
///
/// LBT coins can only be unlocked if they no longer have an applied lockup period
#[derive(Parser)]
...
/// Withdraw unlocked staked LBT from a stake pool
///
...
/// Increase lockup of all staked LBT in a stake pool
///
