...
pub const USER_AGENT: &str = concat!("libra2-cli/", env!("CARGO_PKG_VERSION"));
...
pub struct ProfileConfig {
    ...
    /// URL for the Libra2 rest endpoint
    #[serde(skip_serializing_if = "Option::is_none")]
        ...
        match profile.faucet_url {
            ...
            None => match profile.network {
                ...
                Some(Network::Testnet) => {
                    Err(CliError::CommandArgumentError(format!("To get testnet LBT you must visit {}. If you are confident you want to use a faucet programmatically, set --faucet-url or add a faucet URL to .libra2/config.yaml for the current profile", get_mint_site_url(None))))
                },
                _ => {
...
pub struct GasOptions {
    ...
    ///
    /// The amount of Octas (10^-8 LBT) used for a transaction is equal
...
pub fn get_mint_site_url(address: Option<AccountAddress>) -> String {
    ...
    format!("https://libra2.org/network/faucet{}", params)
}
