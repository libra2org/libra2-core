...
/// 1 LBT (might not actually get that much, depending on the faucet)
        ...
        if !funded {
            match network {
                ...
                Network::Testnet => {
                    ...
                    eprintln!("The account has not been funded on chain yet. To fund the account and get LBT on testnet you must visit {}", mint_site_url);
