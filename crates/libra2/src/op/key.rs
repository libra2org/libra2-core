...
/// with all key types used on the Libra2 blockchain.
...
///
/// ```bash
/// libra2 key extract-public-key --private-key-file ./path-to-key --output-file ./path-to-output --key-type bls12381
/// ```
#[derive(Debug, Parser)]
