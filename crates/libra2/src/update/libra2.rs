...
pub struct Libra2UpdateTool {
    ...
    #[clap(long, default_value = "libra2-core")]
    repo_name: String,
...
impl BinaryUpdater for Libra2UpdateTool {
    ...
    fn get_update_info(&self) -> Result<UpdateRequiredInfo> {
        ...
        let latest_release = loop {
            ...
            if release.version.starts_with("libra2-cli-") {
                break release;
            }
        };
    ...
    fn build_updater(&self, info: &UpdateRequiredInfo) -> Result<Box<dyn ReleaseUpdate>> {
        ...
        Update::configure()
            ...
            .target_version_tag(&format!("libra2-cli-v{}", info.target_version))
            .target(target)
