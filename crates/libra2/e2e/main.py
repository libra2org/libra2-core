...
from cases.init import test_libra2_header_included, test_init, test_metrics_accessible
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="What branch the Libra2 CLI used for the localnet should be built from",
    )
    parser.add_argument(
