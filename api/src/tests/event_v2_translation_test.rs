...
static NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE: u64 = 64;
static OPERATIONS_DEFAULT_TO_FA_LBT_STORE: u64 = 65;
...
async fn test_event_v2_translation_coin_withdraw_event() {
    ...
    context.disable_feature(MODULE_EVENT_MIGRATION).await;
    context
        .disable_feature(NEW_ACCOUNTS_DEFAULT_TO_FA_LBT_STORE)
        .await;
    context
        .disable_feature(OPERATIONS_DEFAULT_TO_FA_LBT_STORE)
        .await;
    context
