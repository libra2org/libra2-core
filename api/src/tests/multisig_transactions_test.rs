...
async fn test_multisig_transaction_with_payload_succeeds(
    ...
    // The multisig tx that transfers away 1000 LBT should have succeeded.
...
async fn test_multisig_transaction_with_payload_and_failing_execution(
    ...
    context
        ...
        .await;
    // Target transaction execution should fail because the multisig account only has 1000 LBT but
